...
source = 'Data/Throw_4.mp4'  # source is the captured video from file
...
out_pose    = cv2.VideoWriter("Data/pose_throw_4.mp4", cv2.VideoWriter_fourcc(*"XVID"), fps, (frame_width, frame_height))
...
with open('Data/Point_matrix_throw_4.csv', 'w', newline = '') as csvfile:
